...
The NECB is a <b>broad</b> concept, we can't measure it completely with micrometeorologic methods alone.  It represents the net change in ecosystem C per unit time.  
...
* $F_{PC}$: Fluxes of bulk/particulate carbon (PC)
  * A bit of a catch all - flux of particulate carbon can include all sorts of things:
    ...
    * Grazing herbivores (C removal) and animal droppings (C deposition)
